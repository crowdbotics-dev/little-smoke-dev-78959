"""
Django settings for little_smoke_dev_78959 project.
...
ROOT_URLCONF = 'little_smoke_dev_78959.urls'
...
WSGI_APPLICATION = 'little_smoke_dev_78959.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "little_smoke_dev_78959 API",
    "DESCRIPTION": "API documentation for little_smoke_dev_78959 App",
    "VERSION": "v1",
}
