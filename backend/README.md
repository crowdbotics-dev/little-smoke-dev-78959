...
## Project Structure
    ...
    ├── little_smoke_dev_78959  # Django project configurations
...
1. Clone this repo and `cd little_smoke_dev_78959`
...
2. Clone this repo and `cd little_smoke_dev_78959`
